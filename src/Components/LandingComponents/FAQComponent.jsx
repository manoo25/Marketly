...
const FAQComponent = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "نعم، لديك 7 أيام لإرجاع أي منتجات غير مطابقة للمواصفات أو تالفة. فريق خدمة العملاء متاح على مدار الساعة لمساعدتك في عملية الإرجاع."
    },
    {
      question: "كيف أضمن جودة المنتجات؟",
      answer: "جميع الموردين على منصتنا معتمدين ومفحوصين بعناية. نتابع جودة المنتجات باستمرار ولدينا نظام تقييم شفاف لضمان حصولك على أفضل المنتجات."
    },
    {
