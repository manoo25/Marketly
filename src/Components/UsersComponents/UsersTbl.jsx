...
const UsersTbl = ({ selectedGovernorate, selectedRole , searchName, searchEmail}) => {
  ...
  const filteredUsers = fakeUsers.filter((user) => {
    ...
    const matchName = searchName ? user.username.toLowerCase().includes(searchName.toLowerCase()) : true;
